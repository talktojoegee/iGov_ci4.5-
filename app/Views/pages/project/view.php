                    ...
                    <div class="col-6">
                        <div class="text-right">
                            <h3 class="text-dark mt-1"><span
                                        data-plugin="counterup"><?= number_format($project->project_budget ?? 0) ?></span>
                            </h3>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="widget-rounded-circle card-box">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-right">
                            <h3 class="text-dark mt-1"><span data-plugin="counterup"><?= count($participants) ?></span>
                            </h3>
            ...
            <div class="widget-rounded-circle card-box">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-right">
                            <h3 class="text-dark mt-1"><span
                                        data-plugin="counterup"><?= intval(abs(strtotime($project->project_end_date) - strtotime($project->project_start_date)) / 86400) ?></span>
                            </h3>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal"
                               data-target="#reportModal">Submit Report</a>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-4">
                                <h5>Start Date</h5>
                                <p><?= date('d M, Y', strtotime($project->project_start_date)) ?> <small
                                            class="text-muted"><?= date('h:i a', strtotime($project->project_start_date)) ?></small>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-4">
                                <h5>End Date</h5>
                                <p><?= date('d M, Y', strtotime($project->project_end_date)) ?> <small
                                            class="text-muted"><?= date('h:i a', strtotime($project->project_end_date)) ?></small>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div>
                        ...
                        <?php foreach ($participants as $participant): ?>
                            <a href="<?= route_to('view-profile', $participant->employee_id) ?>" data-toggle="tooltip"
                               data-placement="top" title=""
                               data-original-title="<?= $participant->employee_f_name ?? '' ?> <?= $participant->employee_l_name ?? '' ?>"
                               class="d-inline-block">
                                <img src="../assets/images/users/<?= $participant->employee_avatar ?? 'avatar.png' ?>"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?= site_url('/leave-comment') ?>" method="post">
                        <?= csrf_field() ?>
                        <textarea name="comment" class="form-control form-control-light mb-2" style="resize:none;"
                    ...
                    <?php foreach ($conversations as $conversation): ?>
                        <div class="media mb-2 p-2">
                            <img class="mr-2 avatar-sm rounded-circle"
                                 src="../assets/images/users/<?= $conversation->employee_avatar ?? 'avatar.png' ?>"
                                 alt="Generic placeholder image">
                            <div class="media-body">
                                <h5 class="mt-0">
                                    <a href="<?= route_to('view-profile', $conversation->employee_id) ?>"
                                       class="text-reset">
                                        <?= $conversation->employee_f_name ?? '' ?> <?= $conversation->employee_l_name ?? '' ?></a>
                                    <small class="text-muted"><?= date('d M, Y h:i a', strtotime($conversation->created_at)) ?></small>
                                    <br> <small>( <?= $conversation->pos_name ?? '' ?>
                                        , <?= $conversation->dpt_name ?? '' ?>)</small>
                                </h5>
                    ...
                    <div id="accordion" class="mb-3">
                        <?php foreach ($reports as $report): ?>
                            <div class="card mb-1">
                                <div class="card-header" id="heading_<?= $report->project_report_id ?? '' ?>">
                                    <h5 class="m-0">
                                        <a class="text-dark collapsed" data-toggle="collapse"
                                           href="#collapse_<?= $report->project_report_id ?? '' ?>"
                                           aria-expanded="false">
                                ...
                                <div id="collapse_<?= $report->project_report_id ?? '' ?>" class="collapse"
                                     aria-labelledby="heading_<?= $report->project_report_id ?? '' ?>"
                                    ...
                                    <?php foreach ($report_attachments as $report_attachment): ?>
                                        <?php if ($report_attachment->project_report_attachment_report_id == $report->project_report_id): ?>
                                            <a href="/uploads/posts/<?= $report_attachment->project_report_attachment ?>"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col pl-0">
                                            <a href="javascript:void(0);"
                                               class="text-muted font-weight-bold"><?= substr($project->project_name, 0, 23) ?></a>
                                        </div>
                                        <div class="col-auto">
                                            <!-- Button -->
                                            <a target="_blank"
                                               href="/uploads/posts/<?= $attachment->project_attachment ?>"
