                            ...
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            <h3 class="text-dark mt-1"><span
                                                        data-plugin="counterup"><?= count($participants) ?></span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="<?= site_url('/leave-comment') ?>" method="post">
                                        <?= csrf_field() ?>
                                        <textarea name="comment" class="form-control form-control-light mb-2"
                                                  style="resize:none;" placeholder="Write message" id="example-textarea"
                                                  rows="3"></textarea>
                                        <div class="text-right">
                                            <input type="hidden" name="convo_project_id"
                                            ...
                                            <div class="media-body">
                                                <h5 class="mt-0">
                                                    <a href="contacts-profile.html"
                                                       class="text-reset"><?= $conversation->employee_f_name ?? '' ?> <?= $conversation->employee_l_name ?? '' ?></a>
                                        ...
                                        <?php foreach ($reports as $report): ?>
                                            <div class="card mb-1">
                                                <div class="card-header"
                                                     id="heading_<?= $report->project_report_id ?? '' ?>">
                                                    <h5 class="m-0">
                                                ...
                                                <div id="collapse_<?= $report->project_report_id ?? '' ?>"
                                                     class="collapse"
