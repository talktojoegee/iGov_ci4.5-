                    ...
                    <div class="col-lg-4">
                        <?php if (in_array($fleet_setup_permission, $permissions)): ?>
                            <div class="text-lg-right mt-3 mt-lg-0">
                                <a href="<?= site_url('/new-vehicle') ?>" type="button"
                ...
                <div class="row">
                    <div class="col-12">
                        <table id="datatable-buttons"
                            ...
                            <tbody>
                            <?php $i = 1;
                            foreach ($active_vehicles as $active_vehicle): ?>
                                <tr>
                                    <td><?= $i;
                                        $i++; ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= site_url('manage-vehicle') . "/" . $active_vehicle['fv_id']; ?>"
                                           data-toggle="tooltip" data-placement="left" title
                                           data-original-title="Manage Vehicle">
