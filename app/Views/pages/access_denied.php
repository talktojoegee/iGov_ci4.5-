        ...
        <div class="align-items-center d-flex h-100">
            <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <h3 class="mt-0 mb-2">Whoops! Access Denied </h3>
                            ...
                            <a href="<?= site_url() ?>" class="btn btn-success waves-effect waves-light">Back to
                                Dashboard</a>
                        </div>
                        <!-- end row -->
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">2021 -
                        <script>document.write(new Date().getFullYear())</script> &copy; iGov by <a
                                href="javascript: void(0);" class="text-muted">Connexxion Telecom</a></p>
                </footer>
