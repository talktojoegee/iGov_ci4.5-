            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h5 class="my-1"><?= env('APP_CURRENCY') ?><span
                                            data-plugin="counterup"><?= number_format($overallAmount, 2) ?></span></h5>
                                <p class="text-muted mb-1 text-truncate">Overall</p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        <h6 class="text-uppercase">Total: <span
                                    class="float-end"><strong><?= number_format($overall ?? 0) ?></strong></span></h6>
                    </div>
                </div>
            </div> <!-- end card-->
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h5 class="my-1"><?= env('APP_CURRENCY') ?><span
                                            data-plugin="counterup"><?= number_format($authorizedAmount, 2) ?></span>
                                </h5>
                    ...
                    <div class="mt-3">
                        <h6 class="text-uppercase">Total: <span
                                    class="float-end"><strong><?= number_format($authorized ?? 0) ?></strong></span>
                        </h6>
                    </div>
                </div>
            </div> <!-- end card-->
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h5 class="my-1"><?= env('APP_CURRENCY') ?><span
                                            data-plugin="counterup"><?= number_format($approvedAmount, 2) ?></span></h5>
                    ...
                    <div class="mt-3">
                        <h6 class="text-uppercase">Total: <span
                                    class="float-end"><strong><?= number_format($approved ?? 0) ?></strong></span></h6>
                    </div>
                </div>
            </div> <!-- end card-->
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h5 class="my-1"><?= env('APP_CURRENCY') ?><span
                                            data-plugin="counterup"><?= number_format($pendingAmount, 2) ?></span></h5>
                    ...
                    <div class="mt-3">
                        <h6 class="text-uppercase">Total: <span
                                    class="float-end"><strong><?= number_format($pending ?? 0) ?></strong></span></h6>
                    </div>
                </div>
            </div> <!-- end card-->
        </div>
    ...
    <div class="row">
        <?php if (in_array($cash_retirement_permission, $permissions)): ?>
            <div class="col-md-12 mb-3">
                <a href="<?= route_to('new-cash-retirement') ?>"
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap w-100">
                        ...
                        <?php foreach ($my_requests as $key => $request): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= route_to('show-cash-retirement-details', $request['crm_url']) ?>"
