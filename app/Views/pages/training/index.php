...
$training_permission = \App\Enums\Permissions::TRAINING->value;
?>
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <?php if (in_array($training_permission, $permissions)): ?>
                    <a href="<?= site_url('add-new-training') ?>"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <?php if ($authId == $training['author']): ?>
                                            <a class="dropdown-item"
                                               href="<?= site_url('/edit-training/' . $training['slug']) ?>"><i
                                                        class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Edit
                                                Training</a>
                                        <?php endif; ?>
                                        <a class="dropdown-item"
                                           href="<?= site_url('/trainings/' . $training['slug']) ?>"><i
