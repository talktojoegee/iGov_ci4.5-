                    ...
                    <div class="col-lg-8">
                        <div class="text-lg-right">
                            ...
                            <?php if ($circular['p_by'] == session()->user_id && $circular['p_status'] == 0): ?>
                                <a href="<?= site_url('/edit-circular/') . $circular['p_id'] ?>" type="button"
                                   class="btn btn-success">Edit</a>
                            <?php endif; ?>
                            <?php if ($circular['p_signed_by'] == session()->user_id && $circular['p_status'] == 0): ?>
                                <button onclick="signDocument(<?= $circular['p_id'] ?>)" type="button"
                                        class="btn btn-success mr-1">Sign
                                </button>
                                <button onclick="declineDocument(<?= $circular['p_id'] ?>)" type="button"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="float-left">
                                ...
                                <?= esc($circular['written_by']['user_name']) ?>
                                (<?= esc($circular['written_by']['position']['pos_name']) ?>,
                                <?= esc($circular['written_by']['department']['dpt_name'] ?? 'N/A') ?>)
                            </div>
                        </div>
                    </div>
                    <div class="row">
