				...
				<div class="page-title-box">
					<div class="page-title-right">
						<ol class="breadcrumb m-0">
							...
							<li class="breadcrumb-item"><a href="<?=site_url('memos')?>">Circular Board</a></li>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-8">
								...
								<p class="text-muted font-13">
									Below are the circulars you have been assigned as signatory. You can review, sign them with your e-signature, or decline to sign them here.
								</p>
							</div>
							<div class="col-lg-4">
						...
						<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap w-100">
							...
							<?php $i=1; foreach ($circulars as $circular):?>
								<tr>
									<td><?=$i; $i++;?></td>
									<td><?=$circular['p_ref_no']?></td>
									<td><?=$circular['p_subject']?></td>
									<td><?=$circular['created_by']?></td>
									<td>
									...
									<td class="text-center">
										<a href="<?=site_url('view-circular/').$circular['p_id']?>" class="mr-1">View</a>
										...
										<?php if($circular['p_signed_by'] == session()->user_id && $circular['p_status'] == 0):?>
											<a href="javascript:void(0)" onclick="signDocument(<?=$circular['p_id']?>)" class="mr-1 text-success">Sign</a>
											<a href="javascript:void(0)" onclick="declineDocument(<?=$circular['p_id']?>)" class="text-danger">Decline</a>
										<?php endif;?>
									</td>
								</tr>
							<?php endforeach;?>
