...
$circular_permission = \App\Enums\Permissions::CIRCULAR->value;
?>
        ...
        <?php else: foreach ($circulars as $circular): ?>
            <div class="col-lg-4">
                <div class="card-box project-box">
                    <div class="dropdown float-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item"
                               href="<?= site_url('view-circular/') . $circular['p_id'] ?>">View</a>
                        </div>
                    </div> <!-- end dropdown -->
                    <!-- Title-->
                    <h4 class="mt-0"><a href="<?= site_url('view-circular') . "/" . $circular['p_id']; ?>"
                                        class="text-dark"><?= word_limiter($circular['p_subject'], 8) ?></a></h4>
                    <p class="text-muted text-uppercase"><i class="mdi mdi-account-circle"></i>
                        <small><?= $circular['created_by'] ?></small></p>
                    ...
                    <? //=word_limiter($circular['p_body'], 70) ?><!--</p>-->
                    <!--            <p class="text-muted font-13 mb-3 sp-line-2"><a href="-->
                    <? //=site_url('view-circular')."/".$circular['p_id']; ?><!--"  class="font-weight-bold text-muted">view more</a></p>-->
                    <!-- Task info-->
                    <p class="mb-1">
          <span class="pr-3 text-nowrap mb-2 d-inline-block">
            ...
            <span class="text-muted">
              ...
              ?>
                ...
                <span class="avatar-title bg-soft-secondary text-secondary font-20 rounded-circle" data-toggle="tooltip"
                      data-placement="top" title="" data-original-title="<?= $recipient['dpt_name'] ?>">
            ...
            <div class="modal-content">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <p class="mt-3">There are circulars still awaiting your signature. Please click on continue
                            below to attend to these pending requests.</p>
