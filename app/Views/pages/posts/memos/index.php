        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="text-lg-right mt-3 mt-lg-0">
              <a href="<?=site_url('internal-memo')?>" class="btn btn-success"><i class="mdi mdi-plus-circle mr-1"></i> New Memo</a>
              <a href="<?=site_url('/my-memos')?>" type="button" class="btn btn-success waves-effect waves-light mr-1">My Memos</a>
            </div>
            <div class="mt-3 d-flex justify-content-end"><a href="<?=site_url('/memos/requests')?>" type="button" class="btn btn-danger waves-effect waves-light">Signature Requests</a></div>
          </div><!-- end col-->
        </div> <!-- end row -->
      </div> <!-- end card-box -->
    </div><!-- end col-->
      ...
      <div class="col-lg-4">
        <div class="card-box project-box">
          ...
          <h4 class="mt-0">
            ...
            ?>
            <a href="<?=site_url('view-memo/').$memo['p_id']?>" class="text-dark"><?=word_limiter($memo['p_subject'], 7) ?></a></h4>
