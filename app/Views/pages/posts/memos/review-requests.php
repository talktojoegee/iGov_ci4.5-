        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Review Requests</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-8">
                                <h4 class="header-title">All My Review Requests</h4>
                                <p class="text-muted font-13">
                                    Below are the memos you have been assigned as a reviewer.
                                </p>
                            </div>
                            <div class="col-lg-4">
                    ...
                    <form id="verify-doc-signing-form" class="needs-validation" novalidate>
                      ...
                      <small>Please enter the verification code that was sent to you to sign this document.</small>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" onclick="verifyDocumentSigning()" class="btn btn-primary"
                                    id="save-btn">Submit
                            </button>
