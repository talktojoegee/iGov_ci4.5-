            ...
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="stamp-type" name="stamp_type" class="form-control"
                               value="<?= $stamp['stamp_type'] ?>" required>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <div class="radio form-check-inline">
                            <input type="radio" id="inlineRadio1" value="1"
                                   name="stamp_status" <?= $stamp['stamp_status'] == 1 ? 'checked' : '' ?>>
                            <label for="inlineRadio1"> Active </label>
                        </div>
                        <div class="radio form-check-inline">
                            <input type="radio" id="inlineRadio2" value="0"
                                   name="stamp_status" <?= $stamp['stamp_status'] == 0 ? 'checked' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input id="file" type="file" data-plugins="dropify" name="file"
                                   ...
                                   data-default-file="/uploads/stamps/<?= $stamp['stamp_image'] ?>" required/>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <?php if (!empty($employees)): ?>
                                ...
                                <?php foreach ($employees as $employee): ?>
                                    <div class="custom-control custom-checkbox mt-1">
                                        <input type="checkbox" class="custom-control-input user"
                                        ...
                                        >
                                        <label class="custom-control-label strikethrough"
                                               for="<?= $employee['user']['user_id'] ?>">
