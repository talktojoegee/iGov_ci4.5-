			...
			<div class="col-lg-6">
				<div class="card-box">
					...
					<div class="form-group mb-3">
						...
						<input type="text" id="registry-name" name="registry_name" class="form-control" required>
					</div>
					<div class="form-group mb-3">
						<label class="mb-2">Status</label>
						<br/>
						<div class="radio form-check-inline">
							<input type="radio" id="inlineRadio1" value="1" name="registry_status" checked>
							<label for="inlineRadio1"> Active </label>
						</div>
						<div class="radio form-check-inline">
							<input type="radio" id="inlineRadio2" value="0" name="registry_status">
