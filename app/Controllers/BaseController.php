...
//			print_r($responses);
    ...
    protected function _validate_permission($permission): bool
    {
        $permission_model = new UserPermissions();
        $permissions = $permission_model->viewUserPermissions($this->session->user_id);
